...
<div id="mb_login" class="mbskin">
    <div class="mbskin_box">
      ...
      <fieldset id="login_fs">
        ...
        <input type="text" name="mb_id" id="login_id" required class="frm_input required" size="20" maxLength="20" placeholder="이메일">
        ...
        <div id="login_info">
          <div class="login_if_auto chk_box">
            ...
            <label for="login_auto_login"><span></span>아이디 저장하기</label>  
          </div>
          <button type="submit" class="btn_submit">로그인</button>
          <div class="login_if_lpl">
            <a href="<?php echo G5_BBS_URL ?>/register.php" class="join">회원가입</a>
            <a href="<?php echo G5_BBS_URL ?>/password_lost.php" class="login_info_srch">아이디/비밀번호 찾기</a>  
          </div>
        </div>
      </fieldset> 
      </form>
