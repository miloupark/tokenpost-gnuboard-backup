...
if (defined('G5_IS_ADMIN')) {
    ...
    echo '<link rel="stylesheet" href="'.run_replace('head_css_url', G5_CSS_URL.'/default.css"> <link rel="stylesheet" href="/gnuboard5/dist/css/comm.scss?ver='.G5_CSS_VER, G5_URL).'">'.PHP_EOL;
    echo '<link rel="stylesheet" href="'.run_replace('head_css_url', G5_CSS_URL.'/dist/scss/comm.scss"> <link rel="stylesheet" href="/gnuboard5/dist/css/comm.scss?ver='.G5_CSS_VER, G5_URL).'">'.PHP_EOL;
    // echo '<link rel="stylesheet" href="'.run_replace('head_css_url', G5_CSS_URL.'/default.css"> <link rel="stylesheet" href="/gnuboard5/dist/css/comm.scss?ver='.G5_CSS_VER, G5_URL).'">'.PHP_EOL;
    // scss의 모든 파일을 업로드 해줘야 함
  }
?>
<!--[if lte IE 8]>
...
add_javascript('<script defer src="/gnuboard5/dist/js/comm.js?ver='.G5_JS_VER.'"></script>', 0);
add_javascript('<script src="https://cdnjs.cloudflare.com/ajax/libs/Swiper/10.2.0/swiper-bundle.min.js"></script>', 0);
add_javascript('<script src="https://cdnjs.cloudflare.com/ajax/libs/slick-carousel/1.8.1/slick.min.js"></script>', 0);
// js를 그누보드에 넣는 법은 html 하단에 넣는 법 / 이렇게 defer를 넣어주는 법
add_stylesheet('<link rel="stylesheet" href="/font-awesome/css/font-awesome.min.css">', 0);
add_stylesheet('<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.2/css/all.min.css"/>', 0);
add_stylesheet('<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.2/css/brands.min.css"/>', 0);
...
add_stylesheet('<link rel="stylesheet" href="https://helenapark.cafe24.com/gnuboard5/dist/css/comm.css">', 0);
// add_stylesheet('<link rel="stylesheet" href="'.G5_JS_URL.'/gnuboard/dist/css/comm.css">', 0);
